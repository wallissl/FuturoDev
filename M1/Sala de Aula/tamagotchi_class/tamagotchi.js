export class Tamagotchi {
    ...
    brincar(){
        this.felicidade += 10
        this.energia -=10
        console.log(`${this.nome} está brincando. Felicidade: ${this.felicidade} | Energia: ${this.energia}`)
